...
This is equivalent to original blam slam, with now an additional ability to manually loop close the pose graph under the assumption that the initial and final pose of the robot is exactly the same.
